...
export function AboutSection() {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12 items-start">
          ...
          >
            {/* My Journey */}
            <Card className="p-4 sm:p-6 bg-card/50 backdrop-blur-sm border-border/50 hover:shadow-lg transition-all duration-300 group text-left">
              <CardContent className="p-0 space-y-3 sm:space-y-4">
                <h3 className="text-xl sm:text-2xl font-semibold group-hover:text-blue-600 transition-colors duration-300">My Journey</h3>
            ...
            {/* Education Section */}
            <div>
              <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-left">Education</h3>
              <div className="relative">
                ...
                {education.map((item, index) => (
                  <motion.div
                    ...
                    className="relative flex flex-col sm:flex-row items-start mb-8 last:mb-0 group"
                  >
                    <div className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center mr-0 sm:mr-4 mb-2 sm:mb-0 shadow-lg group-hover:shadow-purple-500/50 transition-all duration-300">
          ...
          >
            {/* Skills */}
            <Card className="p-4 sm:p-6 bg-card/50 backdrop-blur-sm border-border/50 hover:shadow-lg transition-all duration-300 group">
              <CardContent className="p-0">
                <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 group-hover:text-blue-600 transition-colors duration-300">Technical Skills</h3>
                <div className="flex flex-wrap gap-2">
                  {skills.map((skill, index) => (
                    ...
                    >
                      <Badge variant="secondary" className="px-2 sm:px-3 py-1 text-xs sm:text-sm hover:bg-blue-600 hover:text-white transition-all duration-300">
                        {skill}
                      </Badge>
                    </motion.div>
                  ))}
          ...
          >
            <div className="space-y-3 sm:space-y-4">
              <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Work Experience</h3>
              <div className="relative">
                ...
                {timeline.map((item, index) => (
                  <motion.div
                    ...
                    className="relative flex flex-col sm:flex-row items-start mb-8 last:mb-0 group"
                  >
                    <div className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center mr-0 sm:mr-4 mb-2 sm:mb-0 shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300">
                      <item.icon className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                    </div>
