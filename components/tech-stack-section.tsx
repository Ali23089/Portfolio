          ...
          <div className="flex flex-wrap justify-center gap-6">
            {[
              ...
              <motion.div
                ...
                className="flex flex-col items-center px-4 py-2 bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 shadow-md hover:shadow-blue-400/40 hover:scale-110 transition-all duration-300 cursor-pointer group"
              >
                <img src={tool.img} alt={tool.name} className="w-10 h-10 mb-2 group-hover:scale-125 transition-transform duration-300" />
                <span className="font-medium text-sm text-blue-900 dark:text-blue-200 group-hover:text-blue-600 transition-colors duration-300">{tool.name}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
