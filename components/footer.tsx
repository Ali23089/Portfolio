...
export function Footer() {
  ...
  return (
    <footer className="relative py-10 sm:py-14 md:py-20 bg-gradient-to-tr from-purple-900/50 via-background to-blue-900/50 border-t border-border/50 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400 animate-glow">Ali Umair</h3>
          <p className="text-base sm:text-lg text-muted-foreground max-w-xs sm:max-w-xl md:max-w-2xl text-center">
          ...
          <Button
            onClick={scrollToTop}
            variant="outline"
            className="rounded-full bg-background/20 backdrop-blur-sm border-white/20 hover:bg-white/10 text-white px-4 py-2 sm:px-6 sm:py-3 text-sm sm:text-base"
          >
            <ArrowUp className="h-4 w-4 mr-2" /> Back to Top
          </Button>
        </motion.div>

        <div className="mt-10 sm:mt-14 md:mt-16 pt-6 sm:pt-8 border-t border-white/10 text-center text-xs sm:text-sm text-muted-foreground">
